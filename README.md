...
## Results
As we care about both positive and negative accuracy, an F score would not be totally appropriate in this instance. Instead, we use Mathews Correlation Coefficient, which gives an output between -1 and 1. A high score represents total agreement with the predicted and actual outputs, whereas a zero represents no correlation. 
